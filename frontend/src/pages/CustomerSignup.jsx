...
const CustomerSignup = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 via-white to-green-50 min-h-screen flex items-center justify-center p-4 font-sans text-slate-900 relative">
      ...
      {/* Back to Home Button */}
      <Link to="/" className="absolute top-6 left-6 flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-md rounded-full text-sm font-bold text-slate-600 hover:text-emerald-600 hover:bg-white shadow-sm hover:shadow-md transition-all group">
      ...
      <div className="w-full max-w-[420px]">
        ...
        <div className="bg-white rounded-[2rem] shadow-2xl shadow-slate-200/60 p-8 md:p-10 border border-slate-100 relative overflow-hidden">
          ...
          <p className="text-slate-500 text-sm mb-6">Join us to go paperless today.</p>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            {/* Full Name */}
            <div>
              <label className="block text-xs font-bold text-slate-900 uppercase tracking-wider mb-1 ml-1">Full Name</label>
              <input 
          ...
          <div className="mt-6 pt-6 border-t border-slate-100 text-center">
            ...
            <Link to="/customer-login" className="inline-block mt-1 text-sm font-bold text-emerald-600 hover:text-green-700 transition-colors">
              Log In here &rarr;
            </Link>
          </div>
        </div>
